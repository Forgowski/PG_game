...
class Button:
    def __init__(self, width, height, x, y, onclick, text, image=None):
        ...
        self._rectangle_text = my_bold_font.render(text, True, (255, 255, 255))
    ...
    def rectangle_text(self):
        return self._rectangle_text

    @rectangle_text.setter
    def rectangle_text(self, value):
        self._rectangle_text = value
        self.set_text_position()
